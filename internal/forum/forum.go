...
func NewForumCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		// 命令的详细描述
		Long: `A good Go practical project, used to create a forum system.
			   Find more miniblog information at:
        	   https://github.com/zeusghj/forum#readme`,
...
func run() error {
	...
	token.Init(viper.GetString("jwt-secret"), known.XUserIDKey, known.XUsernameKey, known.XUserRoleKey)
