...
const (
	// recommendedHomeDir 定义放置 forum 服务配置的默认目录
	recommendedHomeDir = ".forum"

	// defaultConfigName 指定了 forum 服务的默认配置文件名
	defaultConfigName = "forum.yaml"
)
...
func initConfig() {
	...
	// 读取环境变量的前缀为 FORUM，如果是 forum,将自动转变为大写
