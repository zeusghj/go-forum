...
var enUSText = map[int]string{
	...
	ResourcePageNotFound:  "Page not found",
	BindError:             "Error occurred while binding the request body to the struct",
	InvalidParameterError: "Parameter verification failed",
	AuthFailure:           "User not login",
	SignTokenError:        "Sign Token Error",
